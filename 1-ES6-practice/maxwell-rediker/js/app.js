...
function displayPics(){
  ...
  // the console log line of code through an error because by changing all the var declarations to let made that specific variable BLOCK scoped making it impossible to reference outside of the function displayPics()
  console.log(viewed)
